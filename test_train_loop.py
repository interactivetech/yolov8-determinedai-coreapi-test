...
cfg = yaml_load('/Users/mendeza/Documents/2023_projects/ultralytics/ultralytics/yolo/cfg/default.yaml')
pprint(dict(cfg))
cfg.update(dict(model='yolov8n.yaml', data='coco128.yaml', device='cpu',epochs=10))
