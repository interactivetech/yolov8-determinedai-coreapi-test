...
cfg = yaml_load('/run/determined/workdir/yolov8-determinedai-coreapi-test/ultralytics/yolo/cfg/default.yaml')
pprint(dict(cfg))
cfg.update(dict(model='yolov8l.pt', imgsz = 224, data='/run/determined/workdir/shared_fs/data/flir-camera-objects-yolo/data.yaml', device=0,epochs=2,batch=64))
...
# Model
RANK=-1
trainer.model = trainer.get_model(cfg='yolov8n.yaml', weights=None, verbose=RANK == -1)
